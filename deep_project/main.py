...
# ROOT_DIR = os.getcwd()
# weight_name = "/home/js/Mask_RCNN/mask_rcnn_coco_0096.h5"
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.menu_widget.setGeometry(QtCore.QRect(0, 0, 111, 800))
        self.menu_widget.setObjectName("menu_widget")
        self.menu_widget.setStyleSheet("background-color: #45775e")

        self.menu1_widget = QtWidgets.QWidget(self.menu_widget)
        self.menu1_widget.setGeometry(QtCore.QRect(4, 10, 101, 41))
        self.menu1_widget.setObjectName("menu1_widget")

        self.menu_btn = QtWidgets.QPushButton(self.menu1_widget)
        self.menu_btn.setGeometry(QtCore.QRect(10, 10, 75, 23))
        self.menu_btn.setStyleSheet('QPushButton {border-style: double; color: white; font-size: 20px}')
        ...
        self.menu2_widget.setGeometry(QtCore.QRect(3, 70, 101, 611))
        ...
        self.menu_list_VLayout.setGeometry(QtCore.QRect(10, 10, 81, 181))
        ...
        self.menu_Btn_1.setStyleSheet('QPushButton {border-style: double; color: white; }')
        ...
        self.menu_Btn_2.setStyleSheet('QPushButton {border-style: double; color: white; }')
        ...
        self.menu_Btn_3.setStyleSheet('QPushButton {border-style: double; color: white; }')

        self.line = QtWidgets.QFrame(self.menu_widget)
        self.line.setGeometry(QtCore.QRect(100, 0, 21, 700))
        ...
        self.main_widget.setGeometry(QtCore.QRect(130, 10, 1501, 691))
        ...
        self.image_widget_left.setGeometry(QtCore.QRect(85, 115, 400, 180))
        self.image_widget_left.setObjectName("image_widget_left")

        self.mainLeft_img_label = QtWidgets.QLabel(self.image_widget_left)
        self.mainLeft_img_label.setGeometry(QtCore.QRect(0, 0, 400, 180))
        ...
        self.mainlabel.setGeometry(QtCore.QRect(102, 290, 700, 50))
        self.mainlabel.setObjectName("mainlabel")
        self.mainlabel.setStyleSheet('QLabel {font-size:20px; font-weight:bold; font-color: rgb(69,119,94) }')
        ...
        self.mainRight_img_label.setGeometry(QtCore.QRect(800, 100, 600, 600))
        ...
        #
        image = QtGui.QImage('./img/cam_img.jpg')
        ...
        self.main_line = QtWidgets.QFrame(self.main_main_widget)
        self.main_line.setGeometry(QtCore.QRect(700, 100, 30, 700))
        ...
        self.main_menu1_widget.setGeometry(QtCore.QRect(130, 10, 1501, 750))
        ...
        self.subject_label_1.setGeometry(QtCore.QRect(10, 11, 701, 31))
        self.subject_label_1.setObjectName("subject_label_1")
        self.subject_label_1.setStyleSheet("font-size: 20px; font-weight:bold")

        self.realBtn_total_widget = QtWidgets.QWidget(self.real_widget)
        self.realBtn_total_widget.setGeometry(QtCore.QRect(10, 80, 450, 80))
        ...
        self.dirBtn_label.setGeometry(QtCore.QRect(2, 32, 450, 80))
        ...
        self.dirBtn.setIconSize(QtCore.QSize(50,50))
        self.dirBtn.setStyleSheet('QPushButton {border-style: double;}')
        ...
        self.real_playBtn.setIconSize(QtCore.QSize(50,50))
        self.real_playBtn.setStyleSheet('QPushButton {border-style: double;}')
        ...
        self.real_stopBtn.setIconSize(QtCore.QSize(50,50))
        self.real_stopBtn.setStyleSheet('QPushButton {border-style: double;}')

        self.realShow_total_widget = QtWidgets.QWidget(self.real_widget)
        self.realShow_total_widget.setGeometry(QtCore.QRect(10, 180, 1481, 531))
        ...
        self.info_label_1.setGeometry(QtCore.QRect(900, 140, 341, 31))
        self.info_label_1.setObjectName("info_label_1")

        self.info_label_2 = QtWidgets.QLabel(self.real_widget)
        self.info_label_2.setGeometry(QtCore.QRect(1270, 140, 341, 31))
        ...
        self.main_menu2_widget.setGeometry(QtCore.QRect(130, 10, 1501, 750))
        ...
        self.videoWidget_widget.setGeometry(QtCore.QRect(0, 200, 1491, 560))
        ...
        self.videoWidget_total_widget.setGeometry(QtCore.QRect(0, 0, 1491, 450))
        ...
        self.videoLabel_total_widget.setGeometry(QtCore.QRect(10, 470, 1481, 41))
        ...
        self.videoBtn_total_widget.setGeometry(QtCore.QRect(670, 90, 181, 80))
        ...
        self.playBtn.setStyleSheet('QPushButton {border-style: double;}')
        ...
        self.stopBtn.setStyleSheet('QPushButton {border-style: double;}')

        self.videoMenu_total_widget = QtWidgets.QWidget(self.vid_widget)
        self.videoMenu_total_widget.setGeometry(QtCore.QRect(10, 90, 421, 80))
        ...
        self.time_list_Btn.setIconSize(QtCore.QSize(50,50))
        self.time_list_Btn.setStyleSheet('QPushButton {border-style: double;}')

        self.subject_label_2 = QtWidgets.QLabel(self.vid_widget)
        self.subject_label_2.setGeometry(QtCore.QRect(10, 11, 701, 31))
        self.subject_label_2.setObjectName("subject_label_2")
        self.subject_label_2.setStyleSheet("font-size: 20px; font-weight:bold")
        ...
        self.main_menu3_widget.setGeometry(QtCore.QRect(130, 10, 1501, 750))
        ...
        self.subject_label_3.setGeometry(QtCore.QRect(10, 11, 701, 31))
        self.subject_label_3.setObjectName("subject_label_3")
        self.subject_label_3.setStyleSheet("font-size: 20px; font-weight:bold")

        self.condiShow_total_widget = QtWidgets.QWidget(self.func_widget)
        self.condiShow_total_widget.setGeometry(QtCore.QRect(10, 230, 1481, 431))
        ...
        self.condiLabel_total_widget.setGeometry(QtCore.QRect(9, 665, 1481, 31))
        ...
        self.condi_1_widget.setGeometry(QtCore.QRect(10, 60, 331, 149))
        ...
        self.condiShow2_graph1_widget.setGeometry(QtCore.QRect(731, 0, 800, 411))
        ...
        self.condiShow2_graph2_widget.setGeometry(QtCore.QRect(731, 0, 800, 411))
        ...
        self.condiShow2_graph3_widget.setGeometry(QtCore.QRect(731, 0, 800, 411))
    ...
    def dirBtn_clicked(self):
        file_name = QFileDialog.getOpenFileName(None, "FileSearch", "/home/js/Mask_RCNN/save",
                                                "Videos (*.mp4 *.ts *.avi *.mpeg *.mpg *.mkv *.VOB *.m4v)")
        self.file_name = file_name[0]

        if(os.path.isfile(self.file_name)):
            self.dirBtn_label.setText(self.file_name)
            self.dirBtn_label.setStyleSheet("color: black")
    ...
    def display_instances(self, image, image2, boxes, masks, ids, names, scores):
        ...
        for i in range(n_instances):
            ...
            if (ids[i] == 1):
                ...
                image = cv2.putText(
                    image, caption, (x1, y1), cv2.FONT_HERSHEY_COMPLEX, 0.7, (255, 0, 0), 2
                )
            else:
    ...
    def makedir(self):  
        ...
        if os.path.isdir(make_dir):
            self.dir_cnt = len(os.listdir(make_dir))
    ...
    def exec_content(self):
        ...
        while True:
            ...
            if (self.frame_count % frame_rec != 0) & (self.frame_count != 1800):
                continue
            elif self.frame_count == 1800:
                self.f_man.close()
                self.f_woman.close()
    ...
    def retranslateUi(self, Form):
        ...
        # menu1
        self.subject_label_1.setText(QtWidgets.QApplication.translate("Form", "Inference 실시간 비교 영상", None, -1))
        ...
        self.videoLabel_2.setText(QtWidgets.QApplication.translate("Form", "Inference 영상", None, -1))
